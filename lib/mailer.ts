    ...
    <html>
      <head>
        ...
        <style>
          ...
          .header { background: #09090b; padding: 30px; text-align: center; border-bottom: 3px solid #dfb141; }
          .header h1 { color: #ffffff; margin: 0; font-size: 22px; font-weight: 700; letter-spacing: 0.5px; }
          .header p { color: #dfb141; margin: 6px 0 0 0; font-size: 13px; font-weight: 600; text-transform: uppercase; letter-spacing: 1.5px; }
          .badge { display: inline-block; padding: 4px 12px; background: #fef3c7; color: #92400e; font-size: 12px; font-weight: 700; border-radius: 20px; margin-bottom: 20px; }
          ...
          .message-box { background: #f8fafc; border-left: 4px solid #dfb141; padding: 16px; border-radius: 8px; font-size: 14px; line-height: 1.6; color: #334155; margin-top: 8px; }
