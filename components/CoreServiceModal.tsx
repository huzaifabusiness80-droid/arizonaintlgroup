                  ...
                  >
                    ...
                    <ul className="space-y-2.5">
                      {section.items.map((item, iIdx) => (
                        <li
                          key={iIdx}
                          className="flex items-start gap-2.5 text-xs sm:text-sm text-neutral-700 font-normal leading-snug"
                        >
          ...
          <div className="p-4 sm:p-6 bg-[#f8f9fc] border-t border-neutral-200 flex-shrink-0 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto">
              ...
              <a
                ...
                className="w-1/2 sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-[#dfb141] hover:bg-[#c49725] text-white text-xs sm:text-sm font-bold shadow-md transition-all cursor-pointer"
              >
